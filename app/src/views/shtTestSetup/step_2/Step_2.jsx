...
import TestShtQuestion from '../../../components/testShtQuestion/TestShtQuestion';
import { getResults } from '../../../redux/actions/shtTest';
...
const Step_2 = (props) => {
	...
	const questions = useSelector((state) => state.shtTest.questions);
